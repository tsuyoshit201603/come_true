...
ActiveRecord::Schema.define(version: 2019_09_10_052052) do
  ...
  create_table "ideas", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["consumer_id"], name: "index_ideas_on_consumer_id"
  end
  ...
  add_foreign_key "ideas", "businesses"
  add_foreign_key "ideas", "consumers"
end
